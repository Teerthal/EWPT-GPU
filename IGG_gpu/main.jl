...
####RK4 evolution code for solving the SU(2)xU(1) equations of motion in an arbitrary gauge
...
# c @inn(W_1_1)=0=@inn(W_2_1)=@inn(W_3_1) so these terms don't play a role here).:
        gw.*(@inn(W_2_1).*( @inn(dW_3_2_dt) ).-#fs(3,1,2)
        @inn(W_3_1).*( @inn(dW_2_2_dt) )))#fs(2,1,2)
    ...
    @inn(W_1_3_n) =@inn(W_1_3).+dt.*(@d2_xi(W_1_3)./(dx*dx) .+@d2_yi(W_1_3)./(dx*dx) .+@d2_zi(W_1_3)./(dx*dx) .+gw.*( 
        ...
        (@inn(W_2_4).*( @d_xi(W_3_4)./dx .-@d_zi(W_3_3)./dx .+gw.*( @inn(W_1_3) .*@inn(W_2_4) .- @inn(W_1_4).*@inn(W_2_3) )).-#fs(3,3,4)
        ...
        gw.*(@inn(W_2_1).*( @inn(dW_3_3_dt) ).-#fs(3,1,3)
        @inn(W_3_1).*( @inn(dW_2_3_dt) )))#fs(2,1,3)
    ...
    @inn(W_1_4_n) =@inn(W_1_4).+dt.*(@d2_xi(W_1_4)./(dx*dx) .+@d2_yi(W_1_4)./(dx*dx) .+@d2_zi(W_1_4)./(dx*dx) .+gw.*( 
        ...
        (@inn(W_2_3).*-( @d_xi(W_3_4)./dx .-@d_zi(W_3_3)./dx .+gw.*( @inn(W_1_3) .*@inn(W_2_4) .- @inn(W_1_4).*@inn(W_2_3) )).-#fs(3,4,3)
        ...
        gw.*(@inn(W_2_1).*( @inn(dW_3_4_dt) ).-#fs(3,1,4)
        @inn(W_3_1).*( @inn(dW_2_4_dt) )))#fs(2,1,4)
    ...
    @inn(W_2_2_n) =@inn(W_2_2).+dt.*(@d2_xi(W_2_2)./(dx*dx) .+@d2_yi(W_2_2)./(dx*dx) .+@d2_zi(W_2_2)./(dx*dx) .+gw.*( 
        ...
        gw.*(@inn(W_3_1).*( @inn(dW_1_2_dt) ).-#fs(1,1,2)
        @inn(W_1_1).*( @inn(dW_3_2_dt) )))#fs(3,1,2)
    ...
    @inn(W_2_3_n) =@inn(W_2_3).+dt.*(@d2_xi(W_2_3)./(dx*dx) .+@d2_yi(W_2_3)./(dx*dx) .+@d2_zi(W_2_3)./(dx*dx) .+gw.*( 
        ...
        @inn(W_1_4).*( @d_xi(W_3_4)./dx .-@d_zi(W_3_3)./dx .+gw.*( @inn(W_1_3) .*@inn(W_2_4) .- @inn(W_1_4).*@inn(W_2_3) )))#fs(3,3,4)
        ).+
        ...
        gw.*(@inn(W_3_1).*( @inn(dW_1_3_dt) ).-#fs(1,1,3)
        @inn(W_1_1).*( @inn(dW_3_3_dt) )))#fs(3,1,3)
    ...
    @inn(W_2_4_n) =@inn(W_2_4).+dt.*(@d2_xi(W_2_4)./(dx*dx) .+@d2_yi(W_2_4)./(dx*dx) .+@d2_zi(W_2_4)./(dx*dx) .+gw.*( 
        ...
        @inn(W_1_3).*-( @d_xi(W_3_4)./dx .-@d_zi(W_3_3)./dx .+gw.*( @inn(W_1_3) .*@inn(W_2_4) .- @inn(W_1_4).*@inn(W_2_3) )))#fs(3,4,3)
        ...
        gw.*(@inn(W_3_1).*( @inn(dW_1_4_dt) ).-#fs(1,1,4)
        @inn(W_1_1).*( @inn(dW_3_4_dt) )))#fs(3,1,4)
    ...
    @inn(W_3_2_n) =@inn(W_3_2).+dt.*(@d2_xi(W_3_2)./(dx*dx) .+@d2_yi(W_3_2)./(dx*dx) .+@d2_zi(W_3_2)./(dx*dx) .+gw.*( 
        ...
        gw.*(@inn(W_1_1).*( @inn(dW_2_2_dt) ).-#fs(2,1,2)
        @inn(W_2_1).*( @inn(dW_1_2_dt) )))#fs(1,1,2)
    ...
    @inn(W_3_3_n) =@inn(W_3_3).+dt.*(@d2_xi(W_3_3)./(dx*dx) .+@d2_yi(W_3_3)./(dx*dx) .+@d2_zi(W_3_3)./(dx*dx) .+gw.*( 
        ...
        gw.*(@inn(W_1_1).*( @inn(dW_2_3_dt) ).-#fs(2,1,3)
        @inn(W_2_1).*( @inn(dW_1_3_dt) )))#fs(1,1,3)
    ...
    @inn(W_3_4_n) =@inn(W_3_4).+dt.*(@d2_xi(W_3_4)./(dx*dx) .+@d2_yi(W_3_4)./(dx*dx) .+@d2_zi(W_3_4)./(dx*dx) .+gw.*( 
        ...
        gw.*(@inn(W_1_1).*( @inn(dW_2_4_dt) ).-#fs(2,1,4)
        @inn(W_2_1).*( @inn(dW_1_4_dt) )))#fs(1,1,4)
...
@parallel function E_kinetic!(ϕ_1,ϕ_2,ϕ_3,ϕ_4,
    ...
    @inn(E_kin) = ((@inn(dϕ_1_dt) .-@D_1ϕ_1(ϕ_1,ϕ_2,ϕ_3,ϕ_4,W_1_1,W_1_2,W_1_3,W_1_4,W_2_1,W_2_2,W_2_3,W_2_4,W_3_1,W_3_2,W_3_3,W_3_4,Y_1,Y_2,Y_3,Y_4)).*
        (@inn(dϕ_1_dt) .-@D_1ϕ_1(ϕ_1,ϕ_2,ϕ_3,ϕ_4,W_1_1,W_1_2,W_1_3,W_1_4,W_2_1,W_2_2,W_2_3,W_2_4,W_3_1,W_3_2,W_3_3,W_3_4,Y_1,Y_2,Y_3,Y_4))).+
        ((@inn(dϕ_2_dt) .-@D_1ϕ_2(ϕ_1,ϕ_2,ϕ_3,ϕ_4,W_1_1,W_1_2,W_1_3,W_1_4,W_2_1,W_2_2,W_2_3,W_2_4,W_3_1,W_3_2,W_3_3,W_3_4,Y_1,Y_2,Y_3,Y_4)).*
        (@inn(dϕ_2_dt) .-@D_1ϕ_2(ϕ_1,ϕ_2,ϕ_3,ϕ_4,W_1_1,W_1_2,W_1_3,W_1_4,W_2_1,W_2_2,W_2_3,W_2_4,W_3_1,W_3_2,W_3_3,W_3_4,Y_1,Y_2,Y_3,Y_4))).+
        ((@inn(dϕ_3_dt) .-@D_1ϕ_3(ϕ_1,ϕ_2,ϕ_3,ϕ_4,W_1_1,W_1_2,W_1_3,W_1_4,W_2_1,W_2_2,W_2_3,W_2_4,W_3_1,W_3_2,W_3_3,W_3_4,Y_1,Y_2,Y_3,Y_4)).*
        (@inn(dϕ_3_dt) .-@D_1ϕ_3(ϕ_1,ϕ_2,ϕ_3,ϕ_4,W_1_1,W_1_2,W_1_3,W_1_4,W_2_1,W_2_2,W_2_3,W_2_4,W_3_1,W_3_2,W_3_3,W_3_4,Y_1,Y_2,Y_3,Y_4))).+
        ((@inn(dϕ_4_dt) .-@D_1ϕ_4(ϕ_1,ϕ_2,ϕ_3,ϕ_4,W_1_1,W_1_2,W_1_3,W_1_4,W_2_1,W_2_2,W_2_3,W_2_4,W_3_1,W_3_2,W_3_3,W_3_4,Y_1,Y_2,Y_3,Y_4)).*
        (@inn(dϕ_4_dt) .-@D_1ϕ_4(ϕ_1,ϕ_2,ϕ_3,ϕ_4,W_1_1,W_1_2,W_1_3,W_1_4,W_2_1,W_2_2,W_2_3,W_2_4,W_3_1,W_3_2,W_3_3,W_3_4,Y_1,Y_2,Y_3,Y_4)))
    return
end
...
@parallel function E_gradient!(ϕ_1,ϕ_2,ϕ_3,ϕ_4,
    ...
    @inn(E_grad) = ((((@d_xi(ϕ_1)./dx .-@D_2ϕ_1(ϕ_1,ϕ_2,ϕ_3,ϕ_4,W_1_1,W_1_2,W_1_3,W_1_4,W_2_1,W_2_2,W_2_3,W_2_4,W_3_1,W_3_2,W_3_3,W_3_4,Y_1,Y_2,Y_3,Y_4)).*
    (@d_xi(ϕ_1)./dx .-@D_2ϕ_1(ϕ_1,ϕ_2,ϕ_3,ϕ_4,W_1_1,W_1_2,W_1_3,W_1_4,W_2_1,W_2_2,W_2_3,W_2_4,W_3_1,W_3_2,W_3_3,W_3_4,Y_1,Y_2,Y_3,Y_4))).+
    ((@d_xi(ϕ_2)./dx .-@D_2ϕ_2(ϕ_1,ϕ_2,ϕ_3,ϕ_4,W_1_1,W_1_2,W_1_3,W_1_4,W_2_1,W_2_2,W_2_3,W_2_4,W_3_1,W_3_2,W_3_3,W_3_4,Y_1,Y_2,Y_3,Y_4)).*
    (@d_xi(ϕ_2)./dx .-@D_2ϕ_2(ϕ_1,ϕ_2,ϕ_3,ϕ_4,W_1_1,W_1_2,W_1_3,W_1_4,W_2_1,W_2_2,W_2_3,W_2_4,W_3_1,W_3_2,W_3_3,W_3_4,Y_1,Y_2,Y_3,Y_4))).+
    ((@d_xi(ϕ_3)./dx .-@D_2ϕ_3(ϕ_1,ϕ_2,ϕ_3,ϕ_4,W_1_1,W_1_2,W_1_3,W_1_4,W_2_1,W_2_2,W_2_3,W_2_4,W_3_1,W_3_2,W_3_3,W_3_4,Y_1,Y_2,Y_3,Y_4)).*
    (@d_xi(ϕ_3)./dx .-@D_2ϕ_3(ϕ_1,ϕ_2,ϕ_3,ϕ_4,W_1_1,W_1_2,W_1_3,W_1_4,W_2_1,W_2_2,W_2_3,W_2_4,W_3_1,W_3_2,W_3_3,W_3_4,Y_1,Y_2,Y_3,Y_4))).+
    ((@d_xi(ϕ_4)./dx .-@D_2ϕ_4(ϕ_1,ϕ_2,ϕ_3,ϕ_4,W_1_1,W_1_2,W_1_3,W_1_4,W_2_1,W_2_2,W_2_3,W_2_4,W_3_1,W_3_2,W_3_3,W_3_4,Y_1,Y_2,Y_3,Y_4)).*
    (@d_xi(ϕ_4)./dx .-@D_2ϕ_4(ϕ_1,ϕ_2,ϕ_3,ϕ_4,W_1_1,W_1_2,W_1_3,W_1_4,W_2_1,W_2_2,W_2_3,W_2_4,W_3_1,W_3_2,W_3_3,W_3_4,Y_1,Y_2,Y_3,Y_4)))).+
    (((@d_yi(ϕ_1)./dx .-@D_3ϕ_1(ϕ_1,ϕ_2,ϕ_3,ϕ_4,W_1_1,W_1_2,W_1_3,W_1_4,W_2_1,W_2_2,W_2_3,W_2_4,W_3_1,W_3_2,W_3_3,W_3_4,Y_1,Y_2,Y_3,Y_4)).*
    (@d_yi(ϕ_1)./dx .-@D_3ϕ_1(ϕ_1,ϕ_2,ϕ_3,ϕ_4,W_1_1,W_1_2,W_1_3,W_1_4,W_2_1,W_2_2,W_2_3,W_2_4,W_3_1,W_3_2,W_3_3,W_3_4,Y_1,Y_2,Y_3,Y_4))).+
    ((@d_yi(ϕ_2)./dx .-@D_3ϕ_2(ϕ_1,ϕ_2,ϕ_3,ϕ_4,W_1_1,W_1_2,W_1_3,W_1_4,W_2_1,W_2_2,W_2_3,W_2_4,W_3_1,W_3_2,W_3_3,W_3_4,Y_1,Y_2,Y_3,Y_4)).*
    (@d_yi(ϕ_2)./dx .-@D_3ϕ_2(ϕ_1,ϕ_2,ϕ_3,ϕ_4,W_1_1,W_1_2,W_1_3,W_1_4,W_2_1,W_2_2,W_2_3,W_2_4,W_3_1,W_3_2,W_3_3,W_3_4,Y_1,Y_2,Y_3,Y_4))).+
    ((@d_yi(ϕ_3)./dx .-@D_3ϕ_3(ϕ_1,ϕ_2,ϕ_3,ϕ_4,W_1_1,W_1_2,W_1_3,W_1_4,W_2_1,W_2_2,W_2_3,W_2_4,W_3_1,W_3_2,W_3_3,W_3_4,Y_1,Y_2,Y_3,Y_4)).*
    (@d_yi(ϕ_3)./dx .-@D_3ϕ_3(ϕ_1,ϕ_2,ϕ_3,ϕ_4,W_1_1,W_1_2,W_1_3,W_1_4,W_2_1,W_2_2,W_2_3,W_2_4,W_3_1,W_3_2,W_3_3,W_3_4,Y_1,Y_2,Y_3,Y_4))).+
    ((@d_yi(ϕ_4)./dx .-@D_3ϕ_4(ϕ_1,ϕ_2,ϕ_3,ϕ_4,W_1_1,W_1_2,W_1_3,W_1_4,W_2_1,W_2_2,W_2_3,W_2_4,W_3_1,W_3_2,W_3_3,W_3_4,Y_1,Y_2,Y_3,Y_4)).*
    (@d_yi(ϕ_4)./dx .-@D_3ϕ_4(ϕ_1,ϕ_2,ϕ_3,ϕ_4,W_1_1,W_1_2,W_1_3,W_1_4,W_2_1,W_2_2,W_2_3,W_2_4,W_3_1,W_3_2,W_3_3,W_3_4,Y_1,Y_2,Y_3,Y_4)))).+
    (((@d_zi(ϕ_1)./dx .-@D_4ϕ_1(ϕ_1,ϕ_2,ϕ_3,ϕ_4,W_1_1,W_1_2,W_1_3,W_1_4,W_2_1,W_2_2,W_2_3,W_2_4,W_3_1,W_3_2,W_3_3,W_3_4,Y_1,Y_2,Y_3,Y_4)).*
    (@d_zi(ϕ_1)./dx .-@D_4ϕ_1(ϕ_1,ϕ_2,ϕ_3,ϕ_4,W_1_1,W_1_2,W_1_3,W_1_4,W_2_1,W_2_2,W_2_3,W_2_4,W_3_1,W_3_2,W_3_3,W_3_4,Y_1,Y_2,Y_3,Y_4))).+
    ((@d_zi(ϕ_2)./dx .-@D_4ϕ_2(ϕ_1,ϕ_2,ϕ_3,ϕ_4,W_1_1,W_1_2,W_1_3,W_1_4,W_2_1,W_2_2,W_2_3,W_2_4,W_3_1,W_3_2,W_3_3,W_3_4,Y_1,Y_2,Y_3,Y_4)).*
    (@d_zi(ϕ_2)./dx .-@D_4ϕ_2(ϕ_1,ϕ_2,ϕ_3,ϕ_4,W_1_1,W_1_2,W_1_3,W_1_4,W_2_1,W_2_2,W_2_3,W_2_4,W_3_1,W_3_2,W_3_3,W_3_4,Y_1,Y_2,Y_3,Y_4))).+
    ((@d_zi(ϕ_3)./dx .-@D_4ϕ_3(ϕ_1,ϕ_2,ϕ_3,ϕ_4,W_1_1,W_1_2,W_1_3,W_1_4,W_2_1,W_2_2,W_2_3,W_2_4,W_3_1,W_3_2,W_3_3,W_3_4,Y_1,Y_2,Y_3,Y_4)).*
    (@d_zi(ϕ_3)./dx .-@D_4ϕ_3(ϕ_1,ϕ_2,ϕ_3,ϕ_4,W_1_1,W_1_2,W_1_3,W_1_4,W_2_1,W_2_2,W_2_3,W_2_4,W_3_1,W_3_2,W_3_3,W_3_4,Y_1,Y_2,Y_3,Y_4))).+
    ((@d_zi(ϕ_4)./dx .-@D_4ϕ_4(ϕ_1,ϕ_2,ϕ_3,ϕ_4,W_1_1,W_1_2,W_1_3,W_1_4,W_2_1,W_2_2,W_2_3,W_2_4,W_3_1,W_3_2,W_3_3,W_3_4,Y_1,Y_2,Y_3,Y_4)).*
    (@d_zi(ϕ_4)./dx .-@D_4ϕ_4(ϕ_1,ϕ_2,ϕ_3,ϕ_4,W_1_1,W_1_2,W_1_3,W_1_4,W_2_1,W_2_2,W_2_3,W_2_4,W_3_1,W_3_2,W_3_3,W_3_4,Y_1,Y_2,Y_3,Y_4)))))
    # @inn(E_grad) = ((@d_xi(ϕ_1)./dx .-@D_2ϕ_1(ϕ_1,ϕ_2,ϕ_3,ϕ_4,W_1_1,W_1_2,W_1_3,W_1_4,W_2_1,W_2_2,W_2_3,W_2_4,W_3_1,W_3_2,W_3_3,W_3_4,Y_1,Y_2,Y_3,Y_4)).*
    # (@d_xi(ϕ_1)./dx .-@D_2ϕ_1(ϕ_1,ϕ_2,ϕ_3,ϕ_4,W_1_1,W_1_2,W_1_3,W_1_4,W_2_1,W_2_2,W_2_3,W_2_4,W_3_1,W_3_2,W_3_3,W_3_4,Y_1,Y_2,Y_3,Y_4)))
    return
...
@parallel function E_Y_magnetic!(Y_1,Y_2,Y_3,Y_4,E_Y_m)
...
W_1_1,W_1_2,W_1_3,W_1_4,W_2_1,W_2_2,W_2_3,W_2_4,W_3_1,W_3_2,W_3_3,W_3_4,
Y_1,Y_2,Y_3,Y_4,
dϕ_1_dt,dϕ_2_dt,dϕ_3_dt,dϕ_4_dt,
E_kin)
...
@parallel E_Y_magnetic!(Y_1,Y_2,Y_3,Y_4,E_Y_m)
...
for i in range(1,nt,step=1)
    ...
    #         frame(anim)
    #     end
    #     println("Plotting frame time:", toc())
    # end
