#Example script for using ImplicitGlobalGrid julia package found at
...
@views function diffusion3D()
    ...
    me, dims   = init_global_grid(nx, ny, nz);              # Initialize the implicit global grid                           # Initialize the implicit global grid
    ...
    # Postprocessing
    # if (me==0) gif(anim, "diffusion3D.gif", fps = 15) end  
