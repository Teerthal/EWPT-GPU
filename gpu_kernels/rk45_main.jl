...
#     dΣ_dt_n = CUDA.zeros(Float64,(Nx,Ny,Nz))
    ...
    while it < nte
        ...
        k1_W_1_1,k1_W_1_2,k1_W_1_3,k1_W_1_4,
        k1_W_2_1,k1_W_2_2,k1_W_2_3,k1_W_2_4,
        k1_W_3_1,k1_W_3_2,k1_W_3_3,k1_W_3_4,
        k1_Y_1,k1_Y_2,k1_Y_3,k1_Y_4,
        ...
        kt1_Γ_1,kt1_Γ_2,kt1_Γ_3,kt1_Σ,
        gw,gy,gp2,vev,lambda,dx)
        synchronize()

        #Compute k_2 arrays
        @cuda threads=thrds blocks=blks rk4_step!(ϕ_1+k1_ϕ_1 .*dt*a21,ϕ_2+k1_ϕ_2 .*dt*a21,ϕ_3+k1_ϕ_3 .*dt*a21,ϕ_4+k1_ϕ_4 .*dt*a21,
        W_1_1,W_1_2+k1_W_1_2 .*dt*a21,W_1_3+k1_W_1_3 .*dt*a21,W_1_4+k1_W_1_4 .*dt*a21,
        W_2_1,W_2_2+k1_W_2_2 .*dt*a21,W_2_3+k1_W_2_3 .*dt*a21,W_2_4+k1_W_2_4 .*dt*a21,
        W_3_1,W_3_2+k1_W_3_2 .*dt*a21,W_3_3+k1_W_3_3 .*dt*a21,W_3_4+k1_W_3_4 .*dt*a21,
        Y_1,Y_2+k1_Y_2 .*dt*a21,Y_3+k1_Y_3 .*dt*a21,Y_4+k1_Y_4 .*dt*a21,
        Γ_1+k1_Γ_1 .*dt*a21,Γ_2+k1_Γ_2 .*dt*a21,Γ_3+k1_Γ_3 .*dt*a21,Σ+k1_Σ .*dt*a21,
        k2_ϕ_1,k2_ϕ_2,k2_ϕ_3,k2_ϕ_4,
        k2_W_1_1,k2_W_1_2,k2_W_1_3,k2_W_1_4,
        k2_W_2_1,k2_W_2_2,k2_W_2_3,k2_W_2_4,
        k2_W_3_1,k2_W_3_2,k2_W_3_3,k2_W_3_4,
        k2_Y_1,k2_Y_2,k2_Y_3,k2_Y_4,
        ...
        W_1_1,W_1_2+k1_W_1_2 .*dt*a31+k2_W_1_2 .*dt*a32,W_1_3+k1_W_1_3 .*dt*a31+k2_W_1_3 .*dt*a32,W_1_4+k1_W_1_4 .*dt*a31+k2_W_1_4 .*dt*a32,
        W_2_1,W_2_2+k1_W_2_2 .*dt*a31+k2_W_2_2 .*dt*a32,W_2_3+k1_W_2_3 .*dt*a31+k2_W_2_3 .*dt*a32,W_2_4+k1_W_2_4 .*dt*a31+k2_W_2_4 .*dt*a32,
        W_3_1,W_3_2+k1_W_3_2 .*dt*a31+k2_W_3_2 .*dt*a32,W_3_3+k1_W_3_3 .*dt*a31+k2_W_3_3 .*dt*a32,W_3_4+k1_W_3_4 .*dt*a31+k2_W_3_4 .*dt*a32,
        Y_1,Y_2+k1_Y_2 .*dt*a31+k2_Y_2 .*dt*a32,Y_3+k1_Y_3 .*dt*a31+k2_Y_3 .*dt*a32,Y_4+k1_Y_4 .*dt*a31+k2_Y_4 .*dt*a32,
        ...
        W_1_1,W_1_2+k1_W_1_2 .*dt*a41+k2_W_1_2 .*dt*a42+k3_W_1_2 .*dt*a43,W_1_3+k1_W_1_3 .*dt*a41+k2_W_1_3 .*dt*a42+k3_W_1_3 .*dt*a43,W_1_4+k1_W_1_4 .*dt*a41+k2_W_1_4 .*dt*a42+k3_W_1_4 .*dt*a43,
        W_2_1,W_2_2+k1_W_2_2 .*dt*a41+k2_W_2_2 .*dt*a42+k3_W_2_2 .*dt*a43,W_2_3+k1_W_2_3 .*dt*a41+k2_W_2_3 .*dt*a42+k3_W_2_3 .*dt*a43,W_2_4+k1_W_2_4 .*dt*a41+k2_W_2_4 .*dt*a42+k3_W_2_4 .*dt*a43,
        W_3_1,W_3_2+k1_W_3_2 .*dt*a41+k2_W_3_2 .*dt*a42+k3_W_3_2 .*dt*a43,W_3_3+k1_W_3_3 .*dt*a41+k2_W_3_3 .*dt*a42+k3_W_3_3 .*dt*a43,W_3_4+k1_W_3_4 .*dt*a41+k2_W_3_4 .*dt*a42+k3_W_3_4 .*dt*a43,
        Y_1,Y_2+k1_Y_2 .*dt*a41+k2_Y_2 .*dt*a42+k3_Y_2 .*dt*a43,Y_3+k1_Y_3 .*dt*a41+k2_Y_3 .*dt*a42+k3_Y_3 .*dt*a43,Y_4+k1_Y_4 .*dt*a41+k2_Y_4 .*dt*a42+k3_Y_4 .*dt*a43,
        ...
        W_1_1,W_1_2+k1_W_1_2 .*dt*a51+k2_W_1_2 .*dt*a52+k3_W_1_2 .*dt*a53+k4_W_1_2 .*dt*a54,W_1_3+k1_W_1_3 .*dt*a51+k2_W_1_3 .*dt*a52+k3_W_1_3 .*dt*a53+k4_W_1_3 .*dt*a54,W_1_4+k1_W_1_4 .*dt*a51+k2_W_1_4 .*dt*a52+k3_W_1_4 .*dt*a53+k4_W_1_4 .*dt*a54,
        W_2_1,W_2_2+k1_W_2_2 .*dt*a51+k2_W_2_2 .*dt*a52+k3_W_2_2 .*dt*a53+k4_W_2_2 .*dt*a54,W_2_3+k1_W_2_3 .*dt*a51+k2_W_2_3 .*dt*a52+k3_W_2_3 .*dt*a53+k4_W_2_3 .*dt*a54,W_2_4+k1_W_2_4 .*dt*a51+k2_W_2_4 .*dt*a52+k3_W_2_4 .*dt*a53+k4_W_2_4 .*dt*a54,
        W_3_1,W_3_2+k1_W_3_2 .*dt*a51+k2_W_3_2 .*dt*a52+k3_W_3_2 .*dt*a53+k4_W_3_2 .*dt*a54,W_3_3+k1_W_3_3 .*dt*a51+k2_W_3_3 .*dt*a52+k3_W_3_3 .*dt*a53+k4_W_3_3 .*dt*a54,W_3_4+k1_W_3_4 .*dt*a51+k2_W_3_4 .*dt*a52+k3_W_3_4 .*dt*a53+k4_W_3_4 .*dt*a54,
        Y_1,Y_2+k1_Y_2 .*dt*a51+k2_Y_2 .*dt*a52+k3_Y_2 .*dt*a53+k4_Y_2 .*dt*a54,Y_3+k1_Y_3 .*dt*a51+k2_Y_3 .*dt*a52+k3_Y_3 .*dt*a53+k4_Y_3 .*dt*a54,Y_4+k1_Y_4 .*dt*a51+k2_Y_4 .*dt*a52+k3_Y_4 .*dt*a53+k4_Y_4 .*dt*a54,
        ...
        W_1_1,W_1_2+k1_W_1_2 .*dt*a61+k2_W_1_2 .*dt*a62+k3_W_1_2 .*dt*a63+k4_W_1_2 .*dt*a64+k5_W_1_2 .*dt*a65,W_1_3+k1_W_1_3 .*dt*a61+k2_W_1_3 .*dt*a62+k3_W_1_3 .*dt*a63+k4_W_1_3 .*dt*a64+k5_W_1_3 .*dt*a65,W_1_4+k1_W_1_4 .*dt*a61+k2_W_1_4 .*dt*a62+k3_W_1_4 .*dt*a63+k4_W_1_4 .*dt*a64+k5_W_1_4 .*dt*a65,
        W_2_1,W_2_2+k1_W_2_2 .*dt*a61+k2_W_2_2 .*dt*a62+k3_W_2_2 .*dt*a63+k4_W_2_2 .*dt*a64+k5_W_2_2 .*dt*a65,W_2_3+k1_W_2_3 .*dt*a61+k2_W_2_3 .*dt*a62+k3_W_2_3 .*dt*a63+k4_W_2_3 .*dt*a64+k5_W_2_3 .*dt*a65,W_2_4+k1_W_2_4 .*dt*a61+k2_W_2_4 .*dt*a62+k3_W_2_4 .*dt*a63+k4_W_2_4 .*dt*a64+k5_W_2_4 .*dt*a65,
        W_3_1,W_3_2+k1_W_3_2 .*dt*a61+k2_W_3_2 .*dt*a62+k3_W_3_2 .*dt*a63+k4_W_3_2 .*dt*a64+k5_W_3_2 .*dt*a65,W_3_3+k1_W_3_3 .*dt*a61+k2_W_3_3 .*dt*a62+k3_W_3_3 .*dt*a63+k4_W_3_3 .*dt*a64+k5_W_3_3 .*dt*a65,W_3_4+k1_W_3_4 .*dt*a61+k2_W_3_4 .*dt*a62+k3_W_3_4 .*dt*a63+k4_W_3_4 .*dt*a64+k5_W_3_4 .*dt*a65,
        Y_1,Y_2+k1_Y_2 .*dt*a61+k2_Y_2 .*dt*a62+k3_Y_2 .*dt*a63+k4_Y_2 .*dt*a64+k4_Y_2 .*dt*a65,Y_3+k1_Y_3 .*dt*a61+k2_Y_3 .*dt*a62+k3_Y_3 .*dt*a63+k4_Y_3 .*dt*a64+k4_Y_3 .*dt*a65,Y_4+k1_Y_4 .*dt*a61+k2_Y_4 .*dt*a62+k3_Y_4 .*dt*a63+k4_Y_4 .*dt*a64+k5_Y_4 .*dt*a65,
