#Module to compute covariant derivates of the Higgs field in the 
#SU(2)xU(1) Electroweak theory in the temporal gauge

module covariant_derivatives

export D_1ϕ_1
@views function D_1ϕ_1(dϕ_1_dt)
    return dϕ_1_dt
end

export D_1ϕ_2
@views function D_1ϕ_2(dϕ_2_dt)
    return (dϕ_2_dt)
end

export D_1ϕ_3
@views function D_1ϕ_3(dϕ_3_dt)
    return (dϕ_3_dt)
end

export D_1ϕ_4
@views function D_1ϕ_4(dϕ_4_dt)
    return (dϕ_4_dt)
end
