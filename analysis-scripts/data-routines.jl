...
run_paras_1 = ["0.001", 2, 120000, 0.1, 10.0, 256, 0.99, 300, 0.25, 0.0, 0.0, 2]
run_paras_1 = ["0.0", 2, 80000, 0.15, 10.0, 320, 0.99, 200, 0.3592, 0.0, 0.0, 2]
para_arr=[run_paras_1]
##peak-scale-runs##
...
run_paras_2 = ["0.0", 2, 80000, 0.15, 10.0, 320, 0.99, 400, 0.25, 0.0, 0.0, 1]
run_paras_3 = ["0.001", 2, 100000, 0.15, 20.0, 320, 0.99, 500, 0.25, 0.0, 0.0, 1]
run_paras_4 = ["0.0", 2, 160000, 0.1, 10.0, 320, 0.99, 400, 0.25, 0.0, 0.0, 1]
run_paras_5 = ["0.0", 2, 320000, 0.1, 20.0, 256, 0.99, 400, 0.25, 0.0, 0.0, 1]
run_paras_6 = ["0.001", 2, 320000, 0.1, 20.0, 256, 0.99, 400, 0.25, 0.0, 0.0, 1]
run_paras_7 = ["0.001", 2, 320000, 0.1, 20.0, 256, 0.99, 400, 0.46, 0.0, 0.0, 1]
run_paras_8 = ["0.0", 2, 160000, 0.1, 10.0, 320, 0.99, 400, 0.46, 0.0, 0.0, 1]

para_arr_lis = [run_paras_1,run_paras_2,run_paras_3,run_paras_4,run_paras_5,run_paras_6,run_paras_7,run_paras_8]

if size(ARGS,1)>2
    para_arr = [para_arr_lis[parse(Int,ARGS[3])]]
end
...
max_spec_t_idx = 15 #320#
max_spec_t_idx = 10 #256#
...
function dir_name(arr)
    ...
    if ((run_type=="thermal-ensemble-prod") || run_type=="thermal_ens_average")
...
function run_dir(arr)
    ...
    elseif (run_type=="thermal_ens_average")
