...
function thermal_initializer!(ϕ_1,ϕ_2,ϕ_3,ϕ_4,gw,gy,gp2,vev,dx,T,Nx,Ny,Nz)
    ...
    ϕ_1_k = zeros(Float64,(Nx,Ny,Nz))
    ϕ_2_k = zeros(Float64,(Nx,Ny,Nz))
    ϕ_3_k = zeros(Float64,(Nx,Ny,Nz))
    ϕ_4_k = zeros(Float64,(Nx,Ny,Nz))
    Random.seed!(123456)
...
function updater!(Γ_1_n,Γ_2_n,Γ_3_n,Σ_n,
...
function triv_updater!(ϕ_1_n,ϕ_2_n,ϕ_3_n,ϕ_4_n,
    W_1_2_n,W_1_3_n,W_1_4_n,
    W_2_2_n,W_2_3_n,W_2_4_n,
    W_3_2_n,W_3_3_n,W_3_4_n,
    Y_2_n,Y_3_n,Y_4_n,
...
function name_change!(ϕ_1_n,ϕ_2_n,ϕ_3_n,ϕ_4_n,
    W_1_2_n,W_1_3_n,W_1_4_n,
    W_2_2_n,W_2_3_n,W_2_4_n,
    W_3_2_n,W_3_3_n,W_3_4_n,
    Y_2_n,Y_3_n,Y_4_n,
...
function name_change_dot!(dϕ_1_dt_n,dϕ_2_dt_n,dϕ_3_dt_n,dϕ_4_dt_n,
    dW_1_2_dt_n,dW_1_3_dt_n,dW_1_4_dt_n,
    dW_2_2_dt_n,dW_2_3_dt_n,dW_2_4_dt_n,
    dW_3_2_dt_n,dW_3_3_dt_n,dW_3_4_dt_n,
    dY_2_dt_n,dY_3_dt_n,dY_4_dt_n,
...
function run(;thermal_init=false)
    ...
    begin
        ...
        B_x_2 = CUDA.zeros(Float64,(Nx,Ny,Nz))
        B_y_2 = CUDA.zeros(Float64,(Nx,Ny,Nz))
        B_z_2 = CUDA.zeros(Float64,(Nx,Ny,Nz))
    ...
    # @time begin
        ##RK-1##
        # println("RK-1")
        @time @cuda threads=thrds blocks=blks rk4_step!(ϕ_1,ϕ_2,ϕ_3,ϕ_4,
            W_1_2,W_1_3,W_1_4,
            W_2_2,W_2_3,W_2_4,
            W_3_2,W_3_3,W_3_4,
            Y_2,Y_3,Y_4,
        ...
        # end
        # println("updates")
        @time @cuda threads=thrds blocks=blks updater_1!(ϕ_1,ϕ_2,ϕ_3,ϕ_4,
            W_1_2,W_1_3,W_1_4,
            W_2_2,W_2_3,W_2_4,
            W_3_2,W_3_3,W_3_4,
            Y_2,Y_3,Y_4,
        ...
        ####
        # synchronize()
        @time @cuda threads=thrds blocks=blks updater_t_1!(dϕ_1_dt,dϕ_2_dt,dϕ_3_dt,dϕ_4_dt,
            dW_1_2_dt,dW_1_3_dt,dW_1_4_dt,
            dW_2_2_dt,dW_2_3_dt,dW_2_4_dt,
            dW_3_2_dt,dW_3_3_dt,dW_3_4_dt,
            dY_2_dt,dY_3_dt,dY_4_dt,
        ...
        @time @cuda threads=thrds blocks=blks triv_updater!(ϕ_1_n,ϕ_2_n,ϕ_3_n,ϕ_4_n,
            W_1_2_n,W_1_3_n,W_1_4_n,
            W_2_2_n,W_2_3_n,W_2_4_n,
            W_3_2_n,W_3_3_n,W_3_4_n,
            Y_2_n,Y_3_n,Y_4_n,
        ...
        @time @cuda threads=thrds blocks=blks rk4_step!(ϕ_1+dϕ_1_dt .*(dt/2.),ϕ_2+dϕ_2_dt .*(dt/2.),ϕ_3+dϕ_3_dt .*(dt/2.),ϕ_4+dϕ_4_dt .*(dt/2.),
        ...
        # end
        # println("updates")
        @time @cuda threads=thrds blocks=blks updater_t!(dϕ_1_dt_n,dϕ_2_dt_n,dϕ_3_dt_n,dϕ_4_dt_n,
            dW_1_2_dt_n,dW_1_3_dt_n,dW_1_4_dt_n,
            dW_2_2_dt_n,dW_2_3_dt_n,dW_2_4_dt_n,
            dW_3_2_dt_n,dW_3_3_dt_n,dW_3_4_dt_n,
            dY_2_dt_n,dY_3_dt_n,dY_4_dt_n,
        ...
        @time @cuda threads=thrds blocks=blks rk4_step!(ϕ_1+(dϕ_1_dt+kt_ϕ_1 .*(dt/2.)) .*(dt/2.),
        ...
        ##Passing f_{n-1} + 0.5*dt*k_3, 
        ## where k_3 = dfdt_{n-1}+dfdt_k3*0.5*dt
        # println("RK-4")

        @time @cuda threads=thrds blocks=blks rk4_step!(ϕ_1+(dϕ_1_dt+kt_ϕ_1 .*(dt/2.)) .*(dt),
        ...
        @time @cuda threads=thrds blocks=blks name_change!(ϕ_1_n,ϕ_2_n,ϕ_3_n,ϕ_4_n,
            W_1_2_n,W_1_3_n,W_1_4_n,
            W_2_2_n,W_2_3_n,W_2_4_n,
            W_3_2_n,W_3_3_n,W_3_4_n,
            Y_2_n,Y_3_n,Y_4_n,
        ...
        @time @cuda threads=thrds blocks=blks name_change_dot!(dϕ_1_dt_n,dϕ_2_dt_n,dϕ_3_dt_n,dϕ_4_dt_n,
            dW_1_2_dt_n,dW_1_3_dt_n,dW_1_4_dt_n,
            dW_2_2_dt_n,dW_2_3_dt_n,dW_2_4_dt_n,
            dW_3_2_dt_n,dW_3_3_dt_n,dW_3_4_dt_n,
            dY_2_dt_n,dY_3_dt_n,dY_4_dt_n,
